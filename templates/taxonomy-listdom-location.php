...
// Main HTML Tag
$html_tag = apply_filters(LSD_Base::TAX_LOCATION.'_html_tag', 'div');

// Title Status
$title_status = apply_filters(LSD_Base::TAX_LOCATION.'_show_title', true);

/**
 * Listdom Location Archive Template
 *
