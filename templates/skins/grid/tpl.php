...
?>
<div class="lsd-skin-wrapper lsd-grid-view-wrapper <?php if($this->sm_shortcode) echo 'lsd-search-position-' . esc_attr($this->sm_position); ?> <?php echo esc_attr($this->html_class); ?> lsd-style-<?php echo esc_attr($this->style); ?> lsd-font-m" id="lsd_skin<?php echo esc_attr($this->id); ?>" data-next-page="<?php echo esc_attr($this->next_page); ?>">
    ...
    <div class="lsd-list-wrapper">
        ...
        <div class="lsd-grid-view-listings-wrapper lsd-viewstyle-grid">
            <div class="lsd-listing-wrapper lsd-grid lsd-g-<?php echo esc_attr($this->columns); ?>-columns">
